...
\includegraphics[width=\textwidth]{assets/2-79_one-step_predictions}
}\\
\subfloat[Windowed period $W_{80-157}$]{
\includegraphics[width=\textwidth]{assets/80-157_one-step_predictions}
}\\
\subfloat[Windowed period $W_{158-235}$]{
\includegraphics[width=\textwidth]{assets/158-235_one-step_predictions}
}%
