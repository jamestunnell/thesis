...
\includegraphics[width=\textwidth]{assets/one-step_predictions_2-79.eps}
}\\
\subfloat[Windowed period $W_{80-157}$]{
\includegraphics[width=\textwidth]{assets/one-step_predictions_80-157.eps}
}\\
\subfloat[Windowed period $W_{158-235}$]{
\includegraphics[width=\textwidth]{assets/one-step_predictions_158-235.eps}
}%
